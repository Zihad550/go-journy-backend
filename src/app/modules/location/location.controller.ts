...
const updateDriverLocation = catchAsync(async (req, res) => {
  const data = await LocationServices.updateDriverLocation(req.user as IJwtPayload as IJwtPayload, req.body);
  sendResponse(res, {
    data,
...
const getDriverLocation = catchAsync(async (req, res) => {
  ...
  const data = await LocationServices.getDriverLocation(req.user as IJwtPayload, driverId, rideId as string);
  sendResponse(res, {
    data,
    statusCode: status.OK,
    success: true,
...
const calculateRoute = catchAsync(async (req, res) => {
  const { rideId } = req.params;
  const data = await LocationServices.calculateRoute(req.user as IJwtPayload, rideId, req.body);
  sendResponse(res, {
    data,
    statusCode: status.OK,
    success: true,
...
const getStoredRoute = catchAsync(async (req, res) => {
  const { rideId } = req.params;
  const data = await LocationServices.getStoredRoute(req.user as IJwtPayload, rideId);
  sendResponse(res, {
    data,
    statusCode: status.OK,
    success: true,
...
const calculateETA = catchAsync(async (req, res) => {
  const { rideId } = req.params;
  const data = await LocationServices.calculateETA(req.user as IJwtPayload, rideId, req.body);
  sendResponse(res, {
    data,
    statusCode: status.OK,
    success: true,
